...
__global__ void   sgemmNN_device(float *A_ptr, float *B_ptr, float *C_ptr, int widthA, int widthB, int heightA) 
//__global__ void   dgemmNN_device( int m, int n, const float *A, int lda, 
