function [sample_group_progression_tree, idx_samples, sample_modules] = group_flow_samples_to_tree(data, target_num_nodes)
...
% for i=1:max(idx_samples), plot(data(1,:),data(2,:),'g.',data(1,idx_samples==i),data(2,idx_samples==i),'b.'); title(i);pause; end
return
