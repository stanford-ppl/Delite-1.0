function DrawTrees_SPDoutputFile(FlowSPD_output_filename,markers_to_draw,is_full_color_range,is_universal_scale,colormap_scheme)
...
if exist('is_universal_scale')  && is_universal_scale==1
    ...
    for i=1:length(surf_ind)
        ...
        [coeff] = DrawTree_subfunc_drawtree(adj,coeff,node_size,marker_names{surf_ind(i)},cluster_median(surf_ind(i),:), max_node_intensity,template, colormap_scheme);
        h2 = figure(2); 
        [coeff] = DrawTree_subfunc_drawtree(adj,coeff,node_size,marker_names{surf_ind(i)},cluster_median(surf_ind(i),:), max_node_intensity,template, colormap_scheme);
        %%%%%%%%%%%%%%%%%%%%%  ES-Start  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        print(h2,['figs\Figures_from_SPDoutputFile_UniScale\',remove_bad_filename_letters(marker_names{surf_ind(i)}),'_from_SPDoutputFile.pdf'],'-dpdf')
        %%%%%%%%%%%%%%%%%%%%  ES-End  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end
    %%%%%%%%%%%%%%%%%%%%%  ES-Start  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    set(h1,'paperunits','inches')
    set(h1,'paperorientation','portrait')
    set(h1,'papersize',[8,6]) % Desired outer dimensions of figure
    set(h1,'paperposition',[-0.5,0,8,6]) % Place plot on figure [dist from left, dist from bottom, width, height]

    print(h1,['figs\Figures_from_SPDoutputFile_UniScale\markers_from_SPDoutputFile','.pdf'],'-dpdf')
    %%%%%%%%%%%%%%%%%%%%  ES-End  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
else
    mkdir('figs\Figures_from_SPDoutputFile\')
    for i=1:length(surf_ind)
        figure(1); subplot(nx,ny,i);
        [coeff] = DrawTree_subfunc_drawtree(adj,coeff,node_size,marker_names{surf_ind(i)},cluster_median(surf_ind(i),:), [],template, colormap_scheme);
        h2 = figure(2); 
        [coeff] = DrawTree_subfunc_drawtree(adj,coeff,node_size,marker_names{surf_ind(i)},cluster_median(surf_ind(i),:), [],template, colormap_scheme);
        %%%%%%%%%%%%%%%%%%%%%  ES-Start  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        set(h2,'paperunits','inches')
        ...
        print(h2,['figs\Figures_from_SPDoutputFile\',remove_bad_filename_letters(marker_names{surf_ind(i)}),'_from_SPDoutputFile.pdf'],'-dpdf')
        %%%%%%%%%%%%%%%%%%%%  ES-End  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end
    %%%%%%%%%%%%%%%%%%%%%  ES-Start  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    set(h1,'paperunits','inches')
    ...
    print(h1,['figs\Figures_from_SPDoutputFile\markers_from_SPDoutputFile','.pdf'],'-dpdf')
    %%%%%%%%%%%%%%%%%%%%  ES-End  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
